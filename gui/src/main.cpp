...
int real_main(int argc, char *argv[])
{
    ...
    SDL_SetHint(SDL_HINT_APP_NAME, "NAX5");
...
#else
	QGuiApplication::setWindowIcon(QIcon(":/icons/nax5.png"));
#endif
	...
	if(!settings.GetCurrentProfile().isEmpty())
		QGuiApplication::setApplicationDisplayName(QString("NAX5:%1").arg(settings.GetCurrentProfile()));
